...
const PlayerCheck = () => {
    return (
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 489.4 489.4" width="40px" height="40px">
            ...
            <path fill='#00B807' d="M244.799,326.8c-44.9,0-81.3,36.4-81.3,81.3s36.4,81.3,81.3,81.3s81.3-36.4,81.3-81.3
